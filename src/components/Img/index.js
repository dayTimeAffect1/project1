...
const Img = (props) => {
    ...
    return (
        <div>
            <Image.PreviewGroup>
                {data.map(v => (
                    <div className={classNames(style.img_container)} key={v} style={{width, height: height || width}}>
                        <div className={classNames(style.img_container_wrapper)}>
                            ...
                            />
                            { del && <div className={classNames(style.img_handle)} onClick={() => del(v)}><CloseCircleFilled /></div>}
                        </div>
                    </div>
                ))}
            </Image.PreviewGroup>
